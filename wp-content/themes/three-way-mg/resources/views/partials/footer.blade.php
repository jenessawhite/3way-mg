...
<footer class="pt-4 container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 nav-wrap">
              <?php
                ...
                if( !empty($image) ): ?>
                <a class="brand" href="{{ home_url('/') }}" target="_blank">
                  <img class="logo img-fluid" src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>">
                </a>
              <?php else: ?>
                <a class="brand" href="{{ home_url('/') }}">{{ get_bloginfo('name', 'display') }}</a target="_blank">
              <?php endif; ?>
    ...
    <div class="footer-copyright py-2 text-center">
      ...
      <?php else: ?>
        © <?php auto_copyright("2018"); ?> {{ get_bloginfo('name', 'display') }}
      <?php endif; ?>
    </div>
    <!--/.Copyright-->
